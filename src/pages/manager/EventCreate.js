...
function EventCreate() {
  ...
  const onSubmit = (e) => {
    ...
    // 시작 시간과 종료 시간을 합치기
    const startDateTime =
      startDate.replace(/-/g, "") + startTime.replace(/:/g, "");
    ...
    axios
      .post("manager/eventcreate", formData)
      .then((res) => {
    ...
    <>
      <div className="flex flex-row">
        ...
        <div className="max-w-[1000px] mx-auto">
          <div className="font-bold text-3xl flex items-center my-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <button
                    ...
                    className="focus:outline-none  bg-yellow-400 hover:bg-yellow-500 
                                        focus:ring-4 focus:ring-yellow-300 font-bold rounded-lg text-lg px-[15px] py-3 me-2 mb-2
