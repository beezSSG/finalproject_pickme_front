...
function CustomerCenter() {
    ...
    useEffect(() => {
      ...
      function topfaqlist() {
        axios.get("http://localhost:8080/api/v1/manager/topfaqlist")
            .then(function(resp){
        ...
        <>     
            ...
            <div className="max-w-[1200px] mx-auto mt-[70px]">
                    ...
                    <div class="flex justify-between items-center mt-[70px]">
                        ...
                        <div className="flex text-xl hover:text-yellow-400 cursor-pointer font-bold"
                            onClick={goFaq}
                        >전체보기
                            <div><PiPlusCircleBold className="text-[25px] text-yellow-400" /></div>
                        </div>
                    </div>
                    ...
                    <div className="text-center text-4xl font-bold mt-[70px]">
                        챗봇
                    </div>
            </div>
